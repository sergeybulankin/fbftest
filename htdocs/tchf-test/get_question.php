<?php
	...
	if (count($res)!==0) {
		if ($res[0]['answer']=='1') $checked_one=' checked ';

		if ($res[0]['answer']=='2') $checked_two=' checked ';

		if ($res[0]['answer']=='3') $checked_three=' checked ';

		if ($res[0]['answer']=='4') $checked_four=' checked ';
	}
